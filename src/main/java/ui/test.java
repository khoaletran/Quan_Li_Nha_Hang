...
public class test extends Application {
    ...
    public void start(Stage stage) throws Exception {
        FXMLLoader fxmlLoader = new FXMLLoader(test.class.getResource("/FXML/QLBan.fxml"));
        Scene scene = new Scene(fxmlLoader.load(), AppConstants.WINDOW_WIDTH, AppConstants.WINDOW_HEIGHT);

        // Áp dụng CSS
        scene.getStylesheets().add(test.class.getResource("/CSS/QLBan.css").toExternalForm());
